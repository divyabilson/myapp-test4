pipeline {
	...
	SERVICENAME = "myapp-test42"
    	TASKFAMILY = "myapp-test42"
    	CLUSTERNAME = "myapp-test42"
    }
	tools {
		nodejs 'nodejs'
	}
		...
		stage('Deploy to ECS') {
			steps {
				sh '''
                			...
                			export AWS_PROFILE=iamuser
					NEW_IMAGE="696083720229.dkr.ecr.us-east-1.amazonaws.com/myapp-nodejs1:${BUILD_NUMBER}"
